    ...
    <table border="0">
        ...
        <tr><td>OAuth: </td><td><input type="checkbox" name="oauth" onclick="document.getElementById('oauth-scope').style.display = '';document.getElementById('oauth-consumer-key').style.display = '';document.getElementById('oauth-consumer-secret').style.display = '';document.getElementById('oauth-access-token-url').style.display = '';document.getElementById('oauth-access-token-method').style.display = '';"> </td></tr>
